...
<head>
    <title>PCNLekki-Partners Page</title>
    <meta charset="utf-8"> 
...
#user_table { overflow:auto;}
</style>
<script>
function getUsers(){
    $.ajax({
        type: 'POST',
        url: 'userActions.php', //editable: change to action file
...
function editUser(id){
    $.ajax({
        type: 'POST',
        dataType:'JSON',
        url: 'userActions.php', //editable: change to action
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
  ...
  <main class="mdl-layout__content">
    <div class="page-content">
         <?php
		   include "../../includes/layout/userFragment.php";
		 ?>
    </div>
  </main>
</div>                                                                                    
